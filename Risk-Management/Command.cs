...
namespace Risk_Management
{
    ...
    public class Command : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            if (!(string.IsNullOrEmpty(x.Trade)))
            {
                ...
                using (Transaction tx = new Transaction(doc))
                {
                    ...
                    */
                    ...
                    Element eltpc = doc.GetElement(new ElementId(1285429));
                    listofele1.Add(eltpc);
                    Element eltpcc = doc.GetElement(new ElementId(1495511));
                    listofele1.Add(eltpcc);
                    ...
                    Element eltrc = doc.GetElement(new ElementId(1495450));
                    listofele1.Add(eltrc);
                    Element eltrcc = doc.GetElement(new ElementId(1284836));
                    listofele1.Add(eltrcc);
                    #endregion
                    ...
                    Element elv = doc.GetElement(new ElementId(1498183));
                    listofele15.Add(elv);
                    Element elev = doc.GetElement(new ElementId(1340190));
                    listofele15.Add(elev);
                    #endregion
                    ...
                    Element ell = doc.GetElement(new ElementId(1340370));
                    listofele16.Add(ell);
                    Element ele = doc.GetElement(new ElementId(1340368));
                    listofele16.Add(ele);
                    Element elee = doc.GetElement(new ElementId(1340366));
                    listofele16.Add(elee);
                    Element eleee = doc.GetElement(new ElementId(1340364));
                    listofele16.Add(eleee);
                    Element eleeee = doc.GetElement(new ElementId(1338272));
                    listofele16.Add(eleeee);

                    Element elt = doc.GetElement(new ElementId(1498253));
                    listofele16.Add(elt);
                    Element elet = doc.GetElement(new ElementId(1498251));
                    listofele16.Add(elet);
                    Element eleet = doc.GetElement(new ElementId(1498257));
                    listofele16.Add(eleet);
                    Element eleeet = doc.GetElement(new ElementId(1498255));
                    listofele16.Add(eleeet);
                    Element eleeeet = doc.GetElement(new ElementId(1497621));
                    listofele16.Add(eleeeet);
                    #endregion
                    ...
                    double max = Convert.ToDouble(Properties.Settings.Default.Max);
                    double min = Convert.ToDouble(Properties.Settings.Default.Min);
                    double med = Convert.ToDouble(Properties.Settings.Default.Meduim);
                    List<string> percentageCost =new List<string>();
                    List<string> percentageTime = new List<string>();
                    foreach (var item in MainDictionary)
                    {
                        ...
                        {
                            bool Isdouble = double.TryParse(Ex.PlannedDuration,out double xx);
                            if (Isdouble)
                            {
                                ...
                                if (item.Key == Ex.Id)
                                {
                                    if (!(Convert.ToDouble(Ex.ImpactedDuration) == 0))
                                    {
                                        double time = 1 - (Convert.ToDouble(Ex.PlannedDuration) / Convert.ToDouble(Ex.ImpactedDuration));
                                        if (time > Time)
                                        {
                                            Time = time;
                                        }
                                    ...
                                    if (!(Convert.ToDouble(Ex.ImpactedCost) == 0))
                                    {
                                        double cost = 1 - (Convert.ToDouble(Ex.PlannedCost) / Convert.ToDouble(Ex.ImpactedCost));
                                        if (cost > Cost)
                                        {
                                            Cost = cost;
                                        }
                        ...
                        percentageCost.Add(PercentTextcost);
                        percentageTime.Add(PercentTexttime);
                    ...
                    double windowHeightF = final.Height;
                    final.Left = (screenWidthF / 2) - (windowWidthF / 1);
                    final.Top = (screenHeightF / 2) - (windowHeightF / 2);
                    final.Show();
                    final.Topmost = true;
                    #endregion
                    tx.Commit();
